return {
    {
        ...
        config = function()
            ...
            -- I gave up on C-e I don't like it and I don't use it...
            -- vim.keymap.set("n", "<C-e>", function()
            --  harpoon.ui:toggle_quick_menu(harpoon:list(), { height_in_lines = 10 })
            -- end, { desc = "Harpoon: Toggle Quick Menu" })
            --- it should be <leader>h
            -- vim.keymap.set("n", "<leader>e", function()
            --     harpoon.ui:toggle_quick_menu(harpoon:list(), { height_in_lines = 10 })
            -- end, { desc = "Harpoon: Toggle Quick Menu" })

            -- <leader>h makes way more sense or simply :harpoon and call it if a command exists I guess and also don't use this as much tbh
            vim.keymap.set("n", "<leader>h", function()
                harpoon.ui:toggle_quick_menu(harpoon:list(), { height_in_lines = 10 })
            end, { desc = "Harpoon: Toggle Quick Menu" })
