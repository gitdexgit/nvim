...
return {
    ...
    -- I don't use this that much to be honest also it's not really that useful... I need something more like ctrl+d in commmand mode.
    -- also if you want to move around just hit like tab then ctrl+n and ctrl+p but if you have caps trick you can just do down and left...
    -- man tbh you can achieve nice performance without the need for this wilder thing...
    -- {
